...
public class TextToSpeechActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGenerateSpeech = findViewById(R.id.btn_generate);
        ...
        dialog = new Dialog(TextToSpeechActivity.this);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(TextToSpeechActivity.this, Home.class);
            }
        });
        about.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(TextToSpeechActivity.this, AboutActivity.class);
            }
        });
        ...
        btnGenerateSpeech.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (text.equals("")) {
                    Toast.makeText(TextToSpeechActivity.this, "Please enter text", Toast.LENGTH_SHORT).show();
                } else {
